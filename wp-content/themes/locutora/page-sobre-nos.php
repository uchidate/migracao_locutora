...
<main class="site-main">
        ...
        <div class="container">
            <div class="about-grid about-grid-light">
                ...
                <div>
                    ...
                    <p><?php echo esc_html( locutora_field( 'bio_p1', 'Adriana Rosa é locutora profissional brasileira, atriz, radialista e comunicadora de São Paulo. Atua no mercado desde 2004, especializada em gravação de voz para publicidade, rádio, televisão, internet e projetos corporativos. Reconhecida pela versatilidade e qualidade de sua voz, atende clientes de todo o Brasil e do mercado internacional.' ) ); ?></p>
                    <p><?php echo esc_html( locutora_field( 'bio_p2', 'Formada em Produção Audiovisual e Teatro, Adriana também é radialista e possui pós-graduações em Influência Digital e Jornalismo Digital, unindo sólida formação acadêmica à ampla experiência prática no mercado da comunicação e do entretenimento.' ) ); ?></p>
                    <p><?php echo esc_html( locutora_field( 'bio_p3', 'Especialista em locução em português do Brasil, atua em campanhas publicitárias, voice over, vídeos institucionais, treinamentos corporativos, e-learning, URA, conteúdos digitais e produções audiovisuais. Sua experiência permite entregar uma comunicação clara, envolvente e alinhada aos objetivos de cada marca.' ) ); ?></p>
                    <p><?php echo esc_html( locutora_field( 'bio_p4', 'Como atriz profissional, oferece interpretações naturais, autênticas e versáteis, adaptando sua voz para diferentes estilos de locução: institucional, comercial, emocional, inspiracional, varejo, personagens e conteúdos corporativos.' ) ); ?></p>
                    <p><?php echo esc_html( locutora_field( 'bio_p5', 'Sua trajetória inclui passagens por importantes emissoras de rádio, como a Rádio Trianon e a Novabrasil FM. Atualmente, é locutora da Classic Pan, pertencente ao Grupo Jovem Pan, consolidando sua experiência como uma das vozes profissionais mais reconhecidas do mercado.' ) ); ?></p>
                </div>
            </div>
            <div class="values-grid">
                <article>
                    <h3>Missão</h3>
                    <p><?php echo esc_html( locutora_field( 'mission', 'Dar voz às marcas com criatividade, qualidade e atenção aos detalhes, criando conexões autênticas entre empresas e seus públicos.' ) ); ?></p>
                </article>
                <article>
                    <h3>Visão</h3>
                    <p><?php echo esc_html( locutora_field( 'vision', 'Ser referência em locução profissional, reconhecida pela excelência, inovação e relacionamento próximo com cada cliente.' ) ); ?></p>
                </article>
                <article>
                    <h3>Valores</h3>
                    <p><?php echo esc_html( locutora_field( 'values', 'Excelência, inovação, personalização, profissionalismo, ética, comprometimento e respeito em cada projeto.' ) ); ?></p>
                </article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-white">
        <div class="container">
            ...
            <h2><?php echo esc_html( locutora_field( 'studio_title', 'Estúdio próprio com equipamentos profissionais' ) ); ?></h2>
            <p><?php echo esc_html( locutora_field( 'studio_p1', 'Com estúdio próprio e equipamentos profissionais, Adriana Rosa realiza gravações de voz com alta qualidade técnica, garantindo excelente resultado para empresas que precisam de uma comunicação eficiente e profissional.' ) ); ?></p>
